...
namespace ClaudeCodeWorkbench
{
    ...
    internal static class AgentWorkerSdk
    {
        ...
        internal static AgentWorkerLaunch Resolve(JObject request, string runDirectory)
        {
            ...
            if (definition == null)
                throw new InvalidOperationException("Agent Worker 不可用。可选值为 auto、claude、codex、dsh 或 custom:<id>。");
        ...
        internal static JObject Diagnostics(bool probe, JObject request = null)
        {
            ...
            return new JObject
            {
                ...
                ["available"] = available, ["claude"] = claude, ["codex"] = codex, ["dsh"] = dsh,
        ...
        {
            if (harness != "dsh" && !harness.StartsWith("custom:", StringComparison.OrdinalIgnoreCase)) return;
